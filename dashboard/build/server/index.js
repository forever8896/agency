...
import { r as readable, w as writable } from './chunks/index-MYuNOitU.js';
import { c as create_ssr_component, s as setContext, v as validate_component, m as missing_component } from './chunks/ssr-DLVJyBVA.js';
...
async function get_hooks() {
  ...
  let init;
  ({ handle, handleFetch, handleError, handleValidationError, init } = await import('./chunks/hooks.server-tSl76BtK.js'));
  let reroute;
  let transport;
  return {
    handle,
