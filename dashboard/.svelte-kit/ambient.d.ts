...
declare module '$env/static/private' {
	export const AGENCY_DATA_DIR: string;
	...
	export const AGENCY_DIR: string;
	export const LC_ADDRESS: string;
	export const POLL_INTERVAL: string;
	...
	export const CRE_INSTALL: string;
